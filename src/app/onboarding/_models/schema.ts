...
export const onboardingSchema = z.object({
  nickname: z
    .string()
    .min(2, "20자 이하의 한글, 영문, 숫자만 사용해주세요.")
    .max(20, "20자 이하의 한글, 영문, 숫자만 사용해주세요.")
    .refine((val) => !/[^a-zA-Z0-9가-힣ㄱ-ㅎㅏ-ㅣ]/.test(val), {
      message: "특수문자는 입력할 수 없습니다.",
    })
    .refine((val) => !/[ㄱ-ㅎㅏ-ㅣ]/.test(val), {
      message: "단어 또는 문장 형태로 입력해주세요.",
    })
