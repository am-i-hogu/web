...
const AUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  INVALID_ID_TOKEN: "소셜 로그인 인증 정보가 유효하지 않아요. 다시 시도해 주세요.",
  INVALID_REFRESH_TOKEN: "로그인 정보가 올바르지 않습니다. 다시 로그인해 주세요.",
  INVALID_STATE: "로그인 요청이 유효하지 않아요. 다시 시도해 주세요.",
  INVALID_REGISTER_TOKEN: "가입 인증 정보가 올바르지 않습니다. 다시 로그인해 주세요.",
  LOGIN_FAILED: DEFAULT_AUTH_ERROR_MESSAGE,
  PROVIDER_MISMATCH: "로그인 제공자 정보가 일치하지 않아요. 다시 시도해 주세요.",
  REFRESH_TOKEN_EXPIRED: "로그인 시간이 만료되었습니다. 다시 로그인해 주세요.",
  REFRESH_TOKEN_REUSED: "로그인 정보가 만료되었습니다. 다시 로그인해 주세요.",
  REGISTER_TOKEN_EXPIRED: "가입 인증 시간이 만료되었습니다. 다시 로그인해 주세요.",
  ...
  UNKNOWN_AUTH_STATUS: DEFAULT_AUTH_ERROR_MESSAGE,
